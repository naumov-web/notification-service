...
export class Migration1777617786266 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."notifications_status_enum" AS ENUM('pending', 'processing', 'done', 'cancelled')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_838f697dc4d0c503eff8e8910a" ON "notifications" ("eventType") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."templates_channel_enum" AS ENUM('email', 'sms', 'push')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_2db126bc743f1c9159fb63404e" ON "templates" ("channel") `);
        await queryRunner.query(`CREATE TABLE "outbox_events" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" character varying NOT NULL, "payload" jsonb NOT NULL, "processed" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_6689a16c00d09b8089f6237f1d2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_041d72983f975459cb9011d584" ON "outbox_events" ("createdAt") `);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."IDX_041d72983f975459cb9011d584"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_2db126bc743f1c9159fb63404e"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_838f697dc4d0c503eff8e8910a"`);
